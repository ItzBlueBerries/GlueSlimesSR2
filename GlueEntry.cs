                ...
                case "GameCore":
                    {
                        ...
                        glueDefinition.prefab.GetComponent<Identifiable>().tag = "Glue Slime";
                        ...
                        glueDefinition.Diet = new SlimeDiet()
                        {
                            MajorFoodIdentifiableTypeGroups = new IdentifiableTypeGroup[] { Utility.Get<IdentifiableTypeGroup>("VeggieGroup") },
                            MajorFoodGroups = new SlimeEat.FoodGroup[] { SlimeEat.FoodGroup.VEGGIES },
                            ProduceIdents = new IdentifiableType[] { gluePlortType },
                            AdditionalFoodIdents = new IdentifiableType[] { Utility.Get<IdentifiableType>("PinkPlort"), Utility.Get<IdentifiableType>("Pink") },
                            FavoriteIdents = new IdentifiableType[] { Utility.Get<IdentifiableType>("BeetVeggie") }
                        };
                        ...
                        slimeAppearance.Face = UnityEngine.Object.Instantiate(Utility.Get<SlimeAppearance>("PuddleDefault").Face);
                        ...
                        slimeAppearance.Icon = Utility.CreateSprite(Utility.LoadImage("Assets.glue_slime_ico"));
                        slimeAppearance.SplatColor = Color.white;
